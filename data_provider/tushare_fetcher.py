# pyright: reportAssignmentType=false, reportAttributeAccessIssue=false, reportOptionalOperand=false, reportOptionalMemberAccess=false
# -*- coding: utf-8 -*-
"""
===================================
...
class TushareFetcher(BaseFetcher):
    ...
    def _check_rate_limit(self) -> None:
        ...
        if self._call_count >= self.rate_limit_per_minute:
            ...
            sleep_time = max(0.0, 60.0 - elapsed) + 1.0  # +1 秒缓冲
    ...
    def get_realtime_quote(self, stock_code: str) -> UnifiedRealtimeQuote | None:
        ...
        策略：
        1. 优先尝试 Pro 接口（需要至少 2000 点积分）：数据全，稳定性高
    ...
    def get_main_indices(self, region: str = "cn") -> list[dict] | None:
        ...
        try:
            ...
            start_date = (local_now() - pd.Timedelta(days=5)).strftime("%Y%m%d")
    ...
    def get_market_stats(self) -> dict | None:
        ...
        try:
            ...
            start_date = (local_now() - pd.Timedelta(days=20)).strftime("%Y%m%d")
            trade_cal = self._api.trade_cal(
                exchange="",
            ...
            # 如果数据过少（少于 100 条），说明当天数据未就绪，尝试使用前一交易日
